// Confirms that file bytes match the declared supported image type.
export function hasValidImageSignature(file: Pick<Express.Multer.File, 'mimetype' | 'buffer'>): boolean {
