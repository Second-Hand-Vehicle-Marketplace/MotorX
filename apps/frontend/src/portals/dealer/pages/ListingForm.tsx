      ...
      {!isLoading &&
        <form onSubmit={handleSubmit} className="glass-card" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            ...
            <label className="form-group"><span className="form-label">Year of Manufacture *</span><input type="number" inputMode="numeric" className="form-input" value={common.year} onChange={(e) => setCommon({ ...common, year: Number(e.target.value) })} min="1900" required /></label>
            ...
            <label className="form-group"><span className="form-label">Mileage (km) *</span><input type="number" inputMode="numeric" className="form-input" value={attrs.mileageKm} onChange={(e) => setAttrs({ ...attrs, mileageKm: e.target.value })} min="0" required /></label>
            ...
            {showEngine && <label className="form-group"><span className="form-label">Engine Capacity (cc) *</span><input type="number" inputMode="numeric" className="form-input" value={attrs.engineCapacityCc} onChange={(e) => setAttrs({ ...attrs, engineCapacityCc: e.target.value })} min="0" required /></label>}
            {showBattery && (
              <>
                <label className="form-group"><span className="form-label">Battery Capacity (kWh) *</span><input type="number" inputMode="decimal" className="form-input" value={attrs.batteryCapacityKWh} onChange={(e) => setAttrs({ ...attrs, batteryCapacityKWh: e.target.value })} min="0" required /></label>
                <label className="form-group"><span className="form-label">Battery Range (km) *</span><input type="number" inputMode="numeric" className="form-input" value={attrs.batteryRangeKm} onChange={(e) => setAttrs({ ...attrs, batteryRangeKm: e.target.value })} min="0" required /></label>
              </>
            )}

            {(category === 'van' || category === 'bus') && <label className="form-group"><span className="form-label">Seating Capacity</span><input type="number" inputMode="numeric" className="form-input" value={attrs.seatingCapacity} onChange={(e) => setAttrs({ ...attrs, seatingCapacity: e.target.value })} min="0" /></label>}
            {category === 'truck' && <label className="form-group"><span className="form-label">Payload Capacity (kg)</span><input type="number" inputMode="numeric" className="form-input" value={attrs.payloadCapacityKg} onChange={(e) => setAttrs({ ...attrs, payloadCapacityKg: e.target.value })} min="0" /></label>}
            ...
            <label className="form-group"><span className="form-label">Price *</span><input type="number" inputMode="numeric" className="form-input" value={common.price} onChange={(e) => setCommon({ ...common, price: Number(e.target.value) })} min="0" required /></label>
