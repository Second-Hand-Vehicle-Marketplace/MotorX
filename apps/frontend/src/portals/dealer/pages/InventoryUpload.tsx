    ...
    <div style={{ maxWidth: 900, margin: '0 auto' }}>
      ...
      <div className="glass-card" style={{ padding: '1.5rem', marginBottom: '2rem' }}>
        ...
        <p style={{ fontSize: '0.875rem', color: 'var(--color-text-secondary)', lineHeight: 1.6, marginBottom: '1rem' }}>
          CSV rows can include image columns such as <code>image1,image2,...,imageN</code>. ZIP uploads should contain the matching vehicle photos referenced by those columns. Required CSV fields include: <code>make, model, year, price, mileage, bodyType, fuelType, transmission, condition, title, description</code>.
        </p>
