...
export const DealerDashboard: React.FC = () => {
  ...
  return <div>
    <div className="page-header"><div><h1 className="page-title">Dealer Dashboard</h1><p className="page-subtitle">Your inventory overview</p></div><div style={{ display: 'flex', gap: '0.75rem' }}><Link to="/dealer/uploads/new" className="btn btn-secondary">Upload CSV</Link><Link to="/dealer/listings/new" className="btn btn-primary">+ Add Listing</Link></div></div>
