...
export const AuditLogs: React.FC = () => {
  ...
  return <div><div className="page-header"><div><h1 className="page-title">Audit Logs</h1><p className="page-subtitle">Persistent record of significant administrative operations</p></div></div>
    ...
    <div className="glass-card" style={{ padding: '1rem 1.5rem', marginBottom: '1.5rem' }}><select className="form-select" style={{ maxWidth: 240 }} value={filter} onChange={(e) => setFilter(e.target.value as AdminAuditEvent | '')}><option value="">All Event Types</option><option value="dealer_approved">Dealer Approved</option><option value="dealer_rejected">Dealer Rejected</option><option value="user_suspended">User Suspended</option><option value="user_activated">User Activated</option><option value="listing_removed">Listing Removed</option><option value="dealer_document_viewed">Document Viewed</option></select></div>
